...
if typing.TYPE_CHECKING:
    ...
    # should be `set[int] | set[str] | dict[int, IncEx] | dict[str, IncEx] |
    # None`, but mypy can't cope
...
def _iter(
    ...
    # The extra "is not None" guards are not logically necessary but optimizes
    # performance for the simple case.
