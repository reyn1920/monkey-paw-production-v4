...
class AnyUrl(str):
    ...
    def validate(
        ...
        # the regex should always match, if it doesn't please report with
        # details of the URL tried
...
class MongoDsn(AnyUrl):
    ...
    # TODO: Needed to generic "Parts" for "Replica Set", "Sharded Cluster",
    # and other mongodb deployment modes
    @staticmethod
    def get_default_parts(parts: "Parts") -> "Parts":
        return {
            "port": "27017",
...
class IPvAnyNetwork(_BaseNetwork):  # type: ignore
    ...
    def validate(cls, value: NetworkType) -> Union[IPv4Network, IPv6Network]:
        ...
        # Define your own class if you want to specify network address check
        # strictness.
        try:
