...
def is_none_type(value: typing.Any) -> bool:
    ...
    if sys.version_info < (3, 10):
        # raise Exception('below 310', value, type(None))
...
def annotation_is_class(annotation: typing.Any) -> bool:
    ...
    # isclass() returns True for generic type hints (e.g. `list[str]`) until Python 310.
    # NOTE: The guard for Python 39 is because types.GenericAlias is only added in Python 39. This is not a problem
