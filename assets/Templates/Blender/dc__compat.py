...
if PYDANTIC_V2:
    ...
    def get_schema_from_model_field(
        *,
        ...
        # This expects that GenerateJsonSchema was already used to generate the
        # definitions
        json_schema = field_mapping[(field, override_mode or field.mode)]
        if "$ref" not in json_schema:
            # TODO remove when deprecating Pydantic v1
            # Ref:
            # https://github.com/pydantic/pydantic/blob/d61792cc42c80b13b23e3ffa74bc37ec7c77f7d1/pydantic/schema.py#L207
            json_schema["title"] = (
    ...
    def serialize_sequence_value(*, field: ModelField, value: Any) -> Sequence[Any]:
        ...
        return sequence_annotation_to_type[origin_type](
            value
    ...
    def is_sequence_field(field: ModelField) -> bool:
        return field.shape in sequence_shapes or _annotation_is_sequence(
            field.type_
        )  # type: ignore[attr-defined]
...
def value_is_sequence(value: Any) -> bool:
    return isinstance(value, sequence_types) and not isinstance(
        value, (str, bytes)
    )  # type: ignore[arg-type]
