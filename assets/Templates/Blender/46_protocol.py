...
class Protocol:
    ...
    def __init__(
        ...
        *,
        ...
        # Connection state. Initially OPEN because subclasses handle
        # CONNECTING.
        self.state = state
    ...
    # Public method for getting outgoing data after receiving data or sending
    # events.
