...
def lstsq(a: ArrayLike, b: ArrayLike, rcond=None):
    a, b = _atleast_float_2(a, b)
    # NumPy is using gelsd: https://github.com/numpy/numpy/blob/v1.240/numpy/linalg/umath_linalg.cpp#L3991
...
def cond(x: ArrayLike, p=None):
    ...
    # check if empty
    # cf: https://github.com/numpy/numpy/blob/v1.240/numpy/linalg/linalg.py#L1744
    ...
    # XXX: NumPy does this: https://github.com/numpy/numpy/blob/v1.240/numpy/linalg/linalg.py#L1744
...
def matrix_rank(a: ArrayLike, tol: None, hermitian=False):
    ...
    if tol is None:
        # follow https://github.com/numpy/numpy/blob/v1.240/numpy/linalg/linalg.py#L1885
        atol = 0
