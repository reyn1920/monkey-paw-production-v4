...
def _registered(
    ...
    # which has minimal memory usage and doesn't even affect garbage
    # collection.
...
class ConstrainedFloat(float, metaclass=ConstrainedNumberMeta):
    ...
    def __modify_schema__(cls, field_schema: Dict[str, Any]) -> None:
        ...
        # Modify constraints to account for differences between IEEE floats and
        # JSON
