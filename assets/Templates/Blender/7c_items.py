...
class Items(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        if not item_id:
            raise ValueError(
                f"Expected a non-empty value for `item_id` but received {item_id!r}"
            )
        return cast(
            ConversationItem,
            self._get(
...
class AsyncItems(AsyncAPIResource):
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"items": items}, item_create_params.ItemCreateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def list(
        ...
        *,
        ...
        ConversationItem, AsyncConversationCursorPage[ConversationItem]
    ]:
        """
        List all items for a conversation with the given ID.
