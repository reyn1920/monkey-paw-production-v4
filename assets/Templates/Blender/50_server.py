...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        self,
        # The version that accepts the path in the second argument is
        # deprecated.
        ws_handler: (
    ...
    async def handshake(
        ...
        if self.state is State.CLOSED:
            # This subclass of ConnectionError is silently ignored in
            # handler().
    ...
    * You can set ``sock`` to a :obj:`~socket.socket` that you created
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Backwards compatibility: recv() used to return None on closed
        # connections
...
def remove_path_argument(
    ...
    try:
        ...
        try:
            ...
            # ws_handler accepts two arguments; activate backwards
            # compatibility.
