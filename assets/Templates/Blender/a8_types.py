...
if TYPE_CHECKING:
    ...
    class ImportString:
        ...
        def __get_pydantic_core_schema__(
            ...
            if cls is source:
                # Treat bare usage of ImportString (`schema is None`) as the
                # same as ImportString[Any]
        ...
        def _serialize(v: Any) -> str:
            ...
            # if we see more of these, we should consider a more general
            # solution
            elif hasattr(v, "name"):
                if v.name == "<stdout>":
                    return "sys.stdout"
...
class Secret(_SecretBase[SecretType]):
    ...
    def __get_pydantic_core_schema__(
        ...
        inner_type = None
        # if origin_type is Secret, then cls is a GenericAlias, and we can
        # extract the inner type directly
...
class Discriminator:
    ...
    def _convert_schema(
        ...
        # Have to do these verbose checks to ensure falsy values ('' and {})
        # don't get ignored
