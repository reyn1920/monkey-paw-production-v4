...
class TranscriptionSessions(SyncAPIResource):
    ...
    def create(
        ...
        *,
        client_secret: (
            transcription_session_create_params.ClientSecret | NotGiven
        ) = NOT_GIVEN,
        ...
        input_audio_noise_reduction: (
            transcription_session_create_params.InputAudioNoiseReduction | NotGiven
        ) = NOT_GIVEN,
        input_audio_transcription: (
            transcription_session_create_params.InputAudioTranscription | NotGiven
        ) = NOT_GIVEN,
        modalities: List[Literal["text", "audio"]] | NotGiven = NOT_GIVEN,
        turn_detection: (
            transcription_session_create_params.TurnDetection | NotGiven
        ) = NOT_GIVEN,
