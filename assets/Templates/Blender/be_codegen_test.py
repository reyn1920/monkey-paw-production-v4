...
#
#     https://www.apache.org/licenses/LICENSE-20
#
...
class AutoFormatTest(test_utils.TestCase, metaclass=AutoFormatTestMeta):
...
def suite():
  ...
  result.addTests(unittest.defaultTestLoader.loadTestsFromTestCase(AutoFormatTest))
  return result
